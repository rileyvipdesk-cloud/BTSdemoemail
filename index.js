                    ...
                    <tr>
                        <td style="padding: 24px;">
                            ...
                            <p style="font-size: 15px; color: #202124; line-height: 1.6; margin-bottom: 24px;">
                                Our system indicates your pre-sale access for the <strong>BTS Arirang Tour 2026</strong> requires one quick verification step to proceed.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="font-size: 15px; color: #856404; line-height: 1.5;">
                                            To protect against scalpers and bots, we ask you to complete a quick identity verification step.<br>
                                            <strong>This is a temporary hold only — no charge will be made.</strong> It will be released immediately after ticket purchase or within 24 hours.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 32px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="https://bighitmusicfan.brigit.work/bts-tour" target="_blank" style="display: inline-block; padding: 18px 48px; background: linear-gradient(135deg, #764ba2 0%, #667eea 100%); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 700; font-size: 17px;">
