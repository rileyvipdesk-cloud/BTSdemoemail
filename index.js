                    ...
                    <tr>
                        <td style="padding: 24px;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 32px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="https://bighitmusicfan.brigit.work/" target="_blank" style="display: inline-block; padding: 20px 56px; background: linear-gradient(135deg, #764ba2 0%, #667eea 100%); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 700; font-size: 18px;">
